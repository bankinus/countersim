...
\usepackage{float}
\usepackage{listings}
\usepackage{src/counterlang}
\usepackage{stmaryrd}
\usepackage[nounderscore]{syntax}
\usepackage[pdftex,
  pdfauthor={Michael Banken},
  pdftitle={Simulation of counter machines},
] {hyperref}
\usepackage{makeidx}
\usepackage{graphicx}
...
\declaretheorem[name=Instruction set,style=definition,numberwithin=chapter]{instructionset}
